...
const leftBox = document.querySelector('.left-box');
	...
	const imagesKitty = [
		'../img/kv1.jpg', // 替换为你的第一张图片路径
		'../img/kv2.jpg', // 替换为你的第二张图片路径
		'../img/kv3.jpg', // 替换为你的第三张图片路径
		'../img/kv4.jpg'  // 替换为你的第四张图片路径
	];
	...
	const imagesKuromi = [
		'../img/ci1.jpg', // 替换为你的第一张图片路径
		'../img/ci2.jpg', // 替换为你的第二张图片路径
		'../img/ci3.jpg', // 替换为你的第三张图片路径
		'../img/ci4.jpg'  // 替换为你的第四张图片路径
	];
	...
	const imagesMeldy = [
		'../img/pomp1.jpg', // 替换为你的第一张图片路径
		'../img/pomp2.jpg', // 替换为你的第二张图片路径
		'../img/pomp3.jpg',
		'../img/pomp4.jpg'
	];
	...
	const imagesPiano = [
		'../img/phc1.jpg', // 替换为你的第一张图片路径
		'../img/phc2.jpg', // 替换为你的第二张图片路径
		'../img/phc3.jpg',
		'../img/phc4.jpg'
	];
...
document.getElementById('redirectBtn').addEventListener('click', function() {
	window.location.href = './Memories.html'; // 替换为你想要跳转的页面
});
...
function createMeteor() {
	...
	// 随机位置
	meteor.style.left = Math.random() * (document.getElementById('meteor-container').clientWidth) + 'px';
	meteor.style.animationDuration = Math.random() * 1 + 0.5 + 's'; // 0.5s - 1.5s
